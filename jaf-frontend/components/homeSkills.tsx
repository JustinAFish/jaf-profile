...
const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  {
    id: "customer-stakeholder-influence",
    gridOrder: 1,
    rowIndex: 1,
    isPrimary: false,
    title: "Customer & Stakeholder Influence",
    skills: [
      "Executive Communication",
      "Technical Discovery & Scoping",
      "Value & ROI Framing",
      "Technical Demo & Prototyping",
      "Change Management",
  ...
  {
    id: "strategic-commercial-thinking",
    gridOrder: 3,
    rowIndex: 3,
    isPrimary: false,
    title: "Strategic & Commercial Thinking",
    skills: [
